var translations = {
    ...
    en: {
        ...
        weightanalytics: {
            ...
            Placeholders: {
                ...
                enterWagonNumber: 'Enter Vehicle number',
                enterWBNumber: 'Enter waybill number',
                selectWagonType: 'Select a Vehicle type',
            ...
            Messages: {
                ...
                noWagonsInWS: 'There is no Vehicle in Weightsheet!',
                notClosedWS: 'Weightsheet is not closed!',
                notAllNettoInWS: 'Not all wagons has Netto! Action cancelled.',
                rejectWeighingConfirm: "Are you sure to reject weighing for Vehicle #{0}?",
                rejectWeighingSuccess: "Weighing for Vehicle #{0} rejected succesfully.",
                ...
                zeroWBConfirm: "Are you sure to set zero?",
                zeroWBSuccess: "Zeroing command has been sent to Scales.",
            },
            Months: {
                January: "January",
                February: "February",
        ...
        consigners: {
            ...
            Labels: {
                ...
                wagon: 'Vehicle',
                wagonType: 'Vehicle type',
                wagonTypeNumber: 'Vehicle type and number',
                wagonNumberCRC: 'Number checksum',
                checksum: 'CS',
                ...
                amkr: 'PJSC Arcelor Mittal Kryviy Rih, INN / EDRPOU 24432974',
                weight: 'Weight',
            ...
            Messages: {
                ...
                errorCreatingWagon: 'Error during creating new Vehicle!',
                ...
                checkWagonExistsConfirm: "Wagon №{0} doesnt exist!\n" +
                                            "Do you want to add this Vehicle to DB?\n" +
                                            "If 'Cancel' waybill will not be created.",
    ...
    ru: {
        ...
        marker: {
            ...
            weightOver2: 'Вес вне заданных пределов',
        ...
        weightanalytics: {
            ...
            Buttons: {
                ...
                open: 'Открыть',
                print: 'Печать',
                remotePrint: 'Удаленная Печать',
                localPrint: 'Местная Печать',
                back: 'Назад',
                close: 'Закрыть',
                cancel: 'Отмена',
            ...
            Placeholders: {
                ...
                enterWagonNumber: 'Введите номер т/с',
                enterWBNumber: 'Введите номер путевой',
                selectWagonType: 'Выберите род т/с',
            ...
            Messages: {
                ...
                notAllNettoInWS: 'Не у всех т/с есть вес Нетто! Действие отменено.',
                rejectWeighingConfirm: "Вы уверены, что хотите забраковать взвешивание т/с №{0}?",
                rejectWeighingSuccess: "Взвешивание т/с №{0} забраковано.",
                ...
                zeroWBConfirm: "Вы уверены, что хотите обнулить весы?",
                zeroWBSuccess: "Команда обнуления весов отправлена.",
            },
            Months: {
                January: "Январь",
                February: "Февраль",
        ...
        consigners: {
            ...
            Labels: {
                ...
                wagon: 'т/с',
                wagonType: 'Род т/с',
                wagonTypeNumber: 'Род и номер т/с',
                wagonNumberCRC: 'Контрольная сумма номера',
                checksum: 'КС',
                cargoType: 'Род груза',
                ...
                amkr: 'ПАО «Арселор Миттал Кривой Рог», ИНН/ЭДРПОУ 24432974',
                weight: 'Вес',
            ...
            Messages: {
                ...
                emptyWagonType: '-- Род т/с не заполнен \n',
                emptyWagonNumber: '-- Номер т/с не заполнен или неверный \n',
                ...
                errorCreatingWagon: 'Ошибка при создании нового т/с!',
                checkWaybillNumberConfirm: "Путевая №{0} (от {2}) для '{1}' уже существует!\n" +
                                            "Вы все равно хотите ее создать?\n" +
                                            "Если 'Отмена', путевая не будет создана.",
                checkWagonExistsConfirm: "т/с №{0} не существует!\n" +
                                            "Вы хотите добавить это т/с в базу данных?\n" +
                                            "Если 'Отмена', путевая не будет создана.",
    ...
    ua: {
        ...
        weightanalytics: {
            ...
            Buttons: {
                ...
                open: 'Відкрити',
                print: 'Друк',
                remotePrint: 'Дистанційний Друк',
                localPrint: 'Місцевий Друк',
                back: 'Назад',
                close: 'Закрити',
                cancel: 'Відміна',
            ...
            Placeholders: {
                ...
                enterWagonNumber: 'Введіть номер т/з',
                enterWBNumber: 'Введіть номер путівої',
                selectWagonType: 'Виберіть рід т/з',
            ...
            Messages: {
                ...
                noWagonsInWS: 'Немає т/з у ваговій!',
                notClosedWS: 'Вагова не закрита!',
                notAllNettoInWS: 'Не всі т/з мають вагу Нетто! Дія скасована.',
                rejectWeighingConfirm: "Ви впевнені, що бажаєте забракувати зважування т/з №{0}?",
                rejectWeighingSuccess: "Зважування т/з №{0} забраковано.",
                ...
                zeroWBConfirm: "Ви впевнені, що бажаєте обнулити ваги?",
                zeroWBSuccess: "Команда обнулення вагів відправлена.",
            },
            Months: {
                January: "Січень",
                February: "Лютий",
        ...
        consigners: {
            ...
            Labels: {
                ...
                wagonTypeNumber: 'Рід та номер т/з',
                wagonNumberCRC: 'Контрольна сума номера',
                checksum: 'КС',
                ...
                amkr: 'ПАТ «Арселор Міттал Кривий Ріг», ІПН / ЕДРПОУ 24432974',
                weight: 'Вага',
            ...
            Messages: {
                ...
                emptyWagonType: '-- Рід т/з не введений \n',
                emptyWagonNumber: '-- Номер т/з не введений або невірний \n',
                ...
                checkWagonExistsConfirm: "т/з №{0} не існує!\n" +
